 ...
 */
final class Version20191127154503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE category_id category_id INT NOT NULL, CHANGE brand_id brand_id INT NOT NULL, CHANGE color_id color_id INT NOT NULL, CHANGE name name VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE price price VARCHAR(255) NOT NULL, CHANGE gender gender VARCHAR(255) NOT NULL');
